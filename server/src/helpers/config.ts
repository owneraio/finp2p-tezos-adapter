...
export const contracts = {
  finp2pAuthAddress : process.env.FINP2P_AUTH_ADDRESS || 'KT19G7ypAK14Q2zGY1udrLzevd2yhoAzbgq3',
  finp2pFA2Address : process.env.FINP2P_FA2_ADDRESS || 'KT1DeiBKdr8zh7i3xSHvXWuB5pHEGREv6pzB',
  finp2pProxyAddress : process.env.FINP2P_PROXY_ADDRESS || 'KT1N1EPC4necEWSUirbdixtWxsMznZq1dPwd',
};
